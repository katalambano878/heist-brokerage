...
const socials = [
  ...
  },
  {
    ...
    href:
      ...
      "https://youtube.com/@heistbrokerage?si=8xZbBXUP9Sr4ZXBW",
    path: "M23.5 6.2a3 3 0 00-2.1-2.1C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.4.6A3 3 0 00.5 6.2 31.2 31.2 0 000 12a31.2 31.2 0 00.5 5.8 3 3 0 002.1 2.1c1.9.6 9.4.6 9.4.6s7.5 0 9.4-.6a3 3 0 002.1-2.1A31.2 31.2 0 0024 12a31.2 31.2 0 00-.5-5.8zM9.6 15.6V8.4L15.8 12l-6.2 3.6z",
    stroke: false,
  },
  {
    label: "WhatsApp",
